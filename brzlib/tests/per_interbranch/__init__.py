...
def load_tests(standard_tests, module, loader):
    submod_tests = loader.loadTestsFromModuleNames([
        'brzlib.tests.per_interbranch.test_fetch',
        'brzlib.tests.per_interbranch.test_get',
        'brzlib.tests.per_interbranch.test_copy_content_into',
        'brzlib.tests.per_interbranch.test_pull',
        'brzlib.tests.per_interbranch.test_push',
        ])
