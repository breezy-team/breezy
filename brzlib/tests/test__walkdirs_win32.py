...
win32_readdir_feature = features.ModuleAvailableFeature('brzlib._walkdirs_win32')
...
class TestWin32Finder(tests.TestCaseInTempDir):
    ...
    def setUp(self):
        ...
        from brzlib._walkdirs_win32 import (
            Win32ReadDir,
            )
...
class Test_Win32Stat(tests.TestCaseInTempDir):
    ...
    def setUp(self):
        ...
        from brzlib._walkdirs_win32 import lstat
