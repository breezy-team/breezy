...
from brzlib.repofmt.knitpack_repo import (
    RepositoryFormatKnitPack5,
    )
from brzlib.repofmt.groupcompress_repo import (
    RepositoryFormat2a,
    )
...
def load_tests(standard_tests, module, loader):
    ...
    supported_tests = loader.loadTestsFromModuleNames([
        'brzlib.tests.per_repository_chk.test_supported'])
    unsupported_tests = loader.loadTestsFromModuleNames([
        'brzlib.tests.per_repository_chk.test_unsupported'])
