...
from brzlib import ignores, osutils
from brzlib.tests import TestCaseWithMemoryTransport
...
class TestExportPot(TestCaseWithMemoryTransport):
    ...
    def test_export_pot_plugin(self):
        self.requireFeature(ModuleAvailableFeature('brzlib.plugins.launchpad'))
