...
class TestHooks(tests.TestCase):
    ...
    def test_docs(self):
        ...
        class MyHooks(Hooks):
            pass
        hooks = MyHooks("brzlib.tests.test_hooks", "some_hooks")
        hooks['legacy'] = []
    ...
    def test_install_named_hook_raises_unknown_hook(self):
        hooks = Hooks("brzlib.tests.test_hooks", "some_hooks")
    ...
    def test_install_named_hook_and_retrieve_name(self):
        hooks = Hooks("brzlib.tests.test_hooks", "somehooks")
        hooks['set_rh'] = []
        hooks.install_named_hook('set_rh', None, "demo")
    ...
    def test_install_named_hook_lazy(self):
        hooks = Hooks("brzlib.tests.hooks", "some_hooks")
        hooks['set_rh'] = HookPoint("set_rh", "doc", (0, 15), None)
        hooks.install_named_hook_lazy('set_rh', 'brzlib.tests.test_hooks',
    ...
    def test_install_named_hook_lazy_old(self):
        ...
        self.assertRaises(errors.UnsupportedOperation,
            ...
            'set_rh', 'brzlib.tests.test_hooks', 'TestHooks.set_rh',
            "demo")
...
class TestHook(tests.TestCase):
    ...
    def test___init__(self):
        doc = ("Invoked after changing the tip of a branch object. Called with"
            "a brzlib.branch.PostChangeBranchTipParams object")
    ...
    def test_docs(self):
        ...
        self.assertEqual("post_tip_change\n"
            ...
            "brzlib.branch.PostChangeBranchTipParams object\n", hook.docs())
    ...
    def test_lazy_hook(self):
        hook = HookPoint("foo", "no docs", None, None)
        hook.hook_lazy(
            "brzlib.tests.test_hooks", "TestHook.lazy_callback",
            "my callback")
...
class TestHookRegistry(tests.TestCase):
    ...
    def test_known_hooks_key_to_object(self):
        self.assertIs(branch.Branch.hooks,
            known_hooks_key_to_object(('brzlib.branch', 'Branch.hooks')))
