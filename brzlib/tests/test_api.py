...
class APITests(TestCase):
    ...
    def test_library_version(self):
        ...
        self.assertTrue(isinstance(brzlib.__version__, str))
        self.assertTrue(isinstance(brzlib.version_string, str))
        self.assertTrue(isinstance(brzlib.version_info, tuple))
        self.assertEqual(len(brzlib.version_info), 5)
...
class TestAPIVersioning(TestCase):
    ...
    def test_require_api_wanted_is_above_current_raises(self):
        ...
        an_object.api_current_version = (4, 5, 6)
        err = self.assertRaises(IncompatibleAPI,
            brzlib.api.require_api, an_object, (4, 5, 7))
        self.assertEqual(err.api, an_object)
