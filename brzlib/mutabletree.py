...
class MutableTree(tree.Tree):
    ...
    The most common form of Mutable Tree is WorkingTree, see brzlib.workingtree.
...
class MutableTreeHooks(hooks.Hooks):
    ...
    def __init__(self):
        ...
        """
        hooks.Hooks.__init__(self, "brzlib.mutabletree", "MutableTree.hooks")
        self.add_hook('start_commit',
            "Called before a commit is performed on a tree. The start commit "
            "hook is able to change the tree before the commit takes place. "
            "start_commit is called with the brzlib.mutabletree.MutableTree "
            "that the commit is being performed on.", (1, 4))
        self.add_hook('post_commit',
            "Called after a commit is performed on a tree. The hook is "
            "called with a brzlib.mutabletree.PostCommitHookParams object. "
...
class _SmartAddHelper(object):
    ...
    def add(self, file_list, recurse=True):
        from brzlib.inventory import InventoryEntry
        if not file_list:
