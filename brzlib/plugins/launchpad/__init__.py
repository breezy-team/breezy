...
from brzlib.help_topics import topic_registry
...
for klsname, aliases in [
    ...
    plugin_cmds.register_lazy(klsname, aliases,
        "brzlib.plugins.launchpad.cmds")


def _register_directory():
    directories.register_lazy('lp:', 'brzlib.plugins.launchpad.lp_directory',
                              'LaunchpadDirectory',
                              'Launchpad-based directory service',)
    directories.register_lazy(
        'debianlp:', 'brzlib.plugins.launchpad.lp_directory',
        'LaunchpadDirectory',
        'debianlp: shortcut')
    directories.register_lazy(
        'ubuntu:', 'brzlib.plugins.launchpad.lp_directory',
        'LaunchpadDirectory',
        'ubuntu: shortcut')
...
def _check_is_up_to_date(the_branch):
    ...
    from brzlib.plugins.launchpad import lp_api_lite
