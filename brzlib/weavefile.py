...
def read_weave(f):
    ...
    from brzlib.weave import Weave
...
def _read_weave_v5(f, w):
    ...
    """
    #  200   0   2075.5080   1084.0360   brzlib.weavefile:104(_read_weave_v5)
    ...
    #  200   0   1492.7170    802.6220   brzlib.weavefile:104(_read_weave_v5)
