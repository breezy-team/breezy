...
format_registry.register_lazy('5', 'brzlib.xml5', 'serializer_v5')
format_registry.register_lazy('6', 'brzlib.xml6', 'serializer_v6')
format_registry.register_lazy('7', 'brzlib.xml7', 'serializer_v7')
format_registry.register_lazy('8', 'brzlib.xml8', 'serializer_v8')
format_registry.register_lazy('9', 'brzlib.chk_serializer',
    'chk_serializer_255_bigpage')
format_registry.register_lazy('10', 'brzlib.chk_serializer',
