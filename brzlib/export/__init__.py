...
register_lazy_exporter(None, [], 'brzlib.export.dir_exporter',
                       'dir_exporter_generator')
register_lazy_exporter('dir', [], 'brzlib.export.dir_exporter',
                       'dir_exporter_generator')
register_lazy_exporter('tar', ['.tar'], 'brzlib.export.tar_exporter',
                       'plain_tar_exporter_generator')
register_lazy_exporter('tgz', ['.tar.gz', '.tgz'],
                       'brzlib.export.tar_exporter',
                       'tgz_exporter_generator')
register_lazy_exporter('tbz2', ['.tar.bz2', '.tbz2'],
                       'brzlib.export.tar_exporter', 'tbz_exporter_generator')
register_lazy_exporter('tlzma', ['.tar.lzma'], 'brzlib.export.tar_exporter',
                       'tar_lzma_exporter_generator')
register_lazy_exporter('txz', ['.tar.xz'], 'brzlib.export.tar_exporter',
                       'tar_xz_exporter_generator')
register_lazy_exporter('zip', ['.zip'], 'brzlib.export.zip_exporter',
