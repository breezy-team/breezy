...
class TestSerializer(TestCase):
    ...
    def test_unpack_revision_5(self):
        ...
        rev = bzrformats.xml5.revision_serializer_v5.read_revision(inp)
        eq = self.assertEqual
    ...
    def test_unpack_inventory_5(self):
        ...
        inv = bzrformats.xml5.inventory_serializer_v5.read_inventory(inp)
        eq = self.assertEqual
        eq(len(inv), 4)
    ...
    def assertRoundTrips(self, xml_string):
        ...
        lines = bzrformats.xml5.inventory_serializer_v5.write_inventory_to_lines(inv)
        outp.seek(0)
        self.assertEqual(outp.readlines(), lines)
        inv2 = bzrformats.xml5.inventory_serializer_v5.read_inventory(
    ...
    def check_repack_revision(self, txt):
        ...
        rev = bzrformats.xml5.revision_serializer_v5.read_revision(inp)
        outfile_contents = (
            bzrformats.xml5.revision_serializer_v5.write_revision_to_string(rev)
        )
        rev2 = bzrformats.xml5.revision_serializer_v5.read_revision(
    ...
    def test_pack_revision_5(self):
        ...
        rev = bzrformats.xml5.revision_serializer_v5.read_revision_from_string(
            _revision_v5
        )
        outfile_contents = (
            bzrformats.xml5.revision_serializer_v5.write_revision_to_string(rev)
        ...
        self.assertEqualDiff(
            outfile_contents,
            b"".join(
                bzrformats.xml5.revision_serializer_v5.write_revision_to_lines(rev)
            ),
        )
    ...
    def test_empty_property_value(self):
        ...
        s_v5 = bzrformats.xml5.revision_serializer_v5
    ...
    def test_wrong_format_v7(self):
        ...
        s_v6 = bzrformats.xml6.inventory_serializer_v6
    ...
    def test_revision_text_v5(self):
        ...
        serialized = bzrformats.xml5.revision_serializer_v5.write_revision_to_lines(rev)
        self.assertEqualDiff(b"".join(serialized), _expected_rev_v5)

    def test_revision_text_v8(self):
        """Pack revision to XML v8."""
        rev = bzrformats.xml8.revision_serializer_v8.read_revision_from_string(
            _expected_rev_v8
        )
        serialized = bzrformats.xml8.revision_serializer_v8.write_revision_to_lines(rev)
    ...
    def test_revision_ids_are_utf8(self):
        ...
        sr_v5 = bzrformats.xml5.revision_serializer_v5
        si_v5 = bzrformats.xml5.inventory_serializer_v5
...
class TestEncodeAndEscape(TestCase):
    ...
    def test_simple_ascii(self):
        ...
        val = bzrformats.xml_serializer.encode_and_escape("foo bar")
        self.assertEqual(b"foo bar", val)
        val2 = bzrformats.xml_serializer.encode_and_escape("foo bar")
        self.assertEqual(val2, val)

    def test_ascii_with_xml(self):
        self.assertEqual(
            b"&amp;&apos;&quot;&lt;&gt;",
            bzrformats.xml_serializer.encode_and_escape("&'\"<>"),
        )
    ...
    def test_utf8_with_xml(self):
        ...
        self.assertEqual(
            b"&#181;&#229;&amp;&#1580;",
            bzrformats.xml_serializer.encode_and_escape(utf8_str),
        )
