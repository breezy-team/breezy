...
try:
    import breezy.plugins.quilt   # noqa: F401
except ImportError:
    ...
    option_registry.register(
        Option('quilt.commit_policy', default=None,
               from_unicode=policy_from_store,
               help="Whether to apply or unapply all patches in commits."))

    option_registry.register(
        Option('quilt.tree_policy', default=None,
               from_unicode=policy_from_store,
               help="Whether to apply or unapply all patches after "
                    "checkout/update."))
