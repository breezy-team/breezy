...
author_list_registry = registry.Registry[str, Callable[[_mod_revision.Revision], List[str]], None]()
...
properties_handler_registry = registry.Registry[str, Callable[[Dict[str, str]], Dict[str, str]], None]()
