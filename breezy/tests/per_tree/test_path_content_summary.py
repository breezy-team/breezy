...
class TestPathContentSummary(per_tree.TestCaseWithTree):
    ...
    def check_content_summary_size(self, tree, summary, expected_size):
        ...
        if returned_size == expected_size or (
            tree.supports_content_filtering() and returned_size is None
        ):
            pass
        else:
    ...
    def test_file_content_summary_executable(self):
        tree = self.make_branch_and_tree("tree")
        if not tree._supports_executable():
        ...
        # may have hash,
        self.assertSubset(
            (summary[3],), (None, b"0c352290ae1c26ca7f97d5b2906c4624784abd60")
        )
    ...
    def test_dir_content_summary(self):
        ...
        if converted_tree.has_versioned_directories() or converted_tree.has_filename(
            "path"
        ):
