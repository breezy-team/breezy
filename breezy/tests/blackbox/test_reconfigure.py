...
class TestReconfigure(TestCaseWithTransportAndScript):
    ...
    def test_force(self):
        ...
        tree.add("file")
        self.run_bzr_error(
            ['Working tree ".*" has uncommitted changes'], "reconfigure --branch tree"
        )
    ...
    def test_make_with_trees_already_trees(self):
        ...
        self.run_bzr_error(
            [" already creates working trees"], "reconfigure --with-trees repo"
        )
    ...
    def test_make_without_trees_already_no_trees(self):
        ...
        repo.set_make_working_trees(False)
        self.run_bzr_error(
            [" already doesn't create working trees"],
