...
class TestBranches(TestCaseWithTransport):
    ...
    def test_recursive(self):
        ...
        lines = out.split(b'\n')
        self.assertIs(True, b'source' in lines, lines)
        self.assertIs(True, b'source/subsource' in lines, lines)
        self.assertIs(True, b'checkout/subcheckout' in lines, lines)
        self.assertIs(True, b'checkout' not in lines, lines)
    ...
    def test_indicates_branch(self):
        ...
        out, err = self.run_bzr('branches a')
        self.assertEqual(out, b"  another\n"
                              b"* colocated\n")
    ...
    def test_shared_repos(self):
        ...
        self.assertEqual(out, b"  branch1\n"
                              b"* branch2\n")
