...
class TestSignatures(per_repository.TestCaseWithRepository):
    ...
    def test_store_signature(self):
        ...
        self.assertRaises(
            errors.NoSuchRevision, branch.repository.has_signature_for_revision_id, b"A"
        )
    ...
    def test_clone_preserves_signatures(self):
        ...
        self.assertEqual(
            repo.get_signature_text(a), d2.open_repository().get_signature_text(a)
        )
    ...
    def test_verify_revision_signature(self):
        ...
        self.assertEqual(
            (gpg.SIGNATURE_VALID, None), repo.verify_revision_signature(a, strategy)
        )
    ...
    def test_verify_revision_signatures(self):
        ...
        self.assertEqual(
            [(a, gpg.SIGNATURE_VALID, None), (b, gpg.SIGNATURE_NOT_SIGNED, None)],
