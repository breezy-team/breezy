...
class TestCommit(TestCaseWithWorkingTree):
    ...
    def test_no_autodelete_renamed_away(self):
        ...
        self.assertThat(
            tree_a,
            HasPathRelations(
                revtree, [("", ""), ("dir2/", "dir2/"), ("dir2/a", "dir/f1")]
            ),
        )
    ...
    def test_commit_exclude_pending_merge_fails(self):
        ...
        self.assertRaises(
            CannotCommitSelectedFileMerge, wt.commit, "test", exclude=["foo"]
        )
    ...
    def test_commit_exclude_exclude_changed_is_pointless(self):
        ...
        self.assertRaises(
            PointlessCommit, tree.commit, "test", exclude=["a"], allow_pointless=False
        )
    ...
    def test_commit_local_unbound(self):
        ...
        tree = self.make_branch_and_tree("tree")
        self.assertRaises(
            errors.LocalRequiresBoundBranch, tree.commit, "foo", local=True
        )
    ...
    def test_local_commit_ignores_master(self):
        ...
        # check its corrupted.
        self.assertRaises(
            errors.UnknownFormatError, controldir.ControlDir.open, "master"
        )
    ...
    def test_nested_commit(self):
        ...
        self.assertEqual(
            subsubtree.last_revision(), sub_basis.get_reference_revision("subtree")
        )
        ...
        self.assertEqual(
            subtree.last_revision(), basis.get_reference_revision("subtree")
        )
    ...
    def test_nested_pointless_commits_are_pointless(self):
        ...
        self.assertRaises(PointlessCommit, tree.commit, "", allow_pointless=False)
