...
class TestMove(TestCaseWithWorkingTree):
    ...
    def test_move_correct_call_named(self):
        ...
        tree.commit("initial commit")
        self.assertEqual(
            [("a1", "sub1/a1")], tree.move(["a1"], to_dir="sub1", after=False)
        )
        tree._validate()
    ...
    def test_move_non_existent(self):
        ...
        tree.add(["a"])
        tree.commit("initial")
        self.assertRaises(errors.BzrMoveFailedError, tree.move, ["not-a-file"], "a")
        self.assertRaises(errors.BzrMoveFailedError, tree.move, ["not-a-file"], "")
        tree._validate()
    ...
    def test_move_over_deleted(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a/", "a/"), ("a/b", "b")]
        )
        tree._validate()
    ...
    def test_move_parent_dir(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a", "a"), ("b/", "b/"), ("c", "b/c")]
        )
    ...
    def test_move_after(self):
        ...
        self.assertEqual([("a", "b/a")], tree.move(["a"], "b"))
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("b/", "b/"), ("b/a", "a")]
        )
        tree._validate()
    ...
    def test_move_after_no_target(self):
        ...
        self.assertRaises(errors.BzrMoveFailedError, tree.move, ["a"], "b", after=True)
    ...
    def test_move_after_source_and_dest(self):
        ...
        self.assertRaises(
            errors.RenameFailedFilesExist, tree.move, ["a"], "b", after=False
        )
        self.assertTreeLayout(["", "a", "b/"], tree)
