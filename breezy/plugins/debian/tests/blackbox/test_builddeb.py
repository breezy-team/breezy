...
class TestBuilddeb(BuilddebTestCase):
    ...
    def build_dir(self):
        return os.path.join(
            "..", "build-area", self.package_name + "-" + str(self.upstream_version)
        )
    ...
    def build_really_simple_tree(self):
        ...
        self.build_tree([self.commited_file, self.uncommited_file, self.unadded_file])
    ...
    def test_builddeb_allows_building_revision_0(self):
        ...
        self.assertNotInBuildDir(
            [self.commited_file, self.unadded_file, self.uncommited_file]
        )
    ...
    def test_utf8_changelog(self):
        ...
        hooks.install_named_hook(
            ...
            "Test builddeb set commit msg hook",
        )
        tree = self.make_unpacked_source()
