    ...
    def parent_candidates(self, previous_inventories):
        ...
        for inv in previous_inventories:
            try:
                ...
                if ie.revision not in candidates:
...
class InventoryDirectory(InventoryEntry):
    ...
    def copy(self):
        other = InventoryDirectory(
            self.file_id, self.name, self.parent_id, revision=self.revision
        )
...
class InventoryLink(InventoryEntry):
    ...
    def __init__(self, file_id, name, parent_id, revision=None, symlink_target=None):
        super().__init__(file_id, name, parent_id)
        self.revision = revision
