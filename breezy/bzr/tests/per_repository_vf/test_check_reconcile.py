...
class FileParentIsNotInRevisionAncestryScenario(BrokenRepoScenario):
    ...
    def populate_repository(self, repo):
        ...
        inv = self.make_one_file_inventory(repo, b"rev2", [b"rev1a", b"rev1b"], root_revision=b"rev2")
...
class FileParentHasInaccessibleInventoryScenario(BrokenRepoScenario):
    ...
    def populate_repository(self, repo):
        ...
        inv = self.make_one_file_inventory(repo, b"rev3", [b"rev1c"], root_revision=b"rev3")
...
class FileParentsNotReferencedByAnyInventoryScenario(BrokenRepoScenario):
    ...
    def populate_repository(self, repo):
        ...
        inv = self.make_one_file_inventory(repo, b"rev2", [b"rev1a"], inv_revision=b"rev1a", root_revision=b"rev2")
        self.add_revision(repo, b"rev2", inv, [b"rev1a"])
        ...
        inv = self.make_one_file_inventory(repo, b"rev3", [b"rev2"], inv_revision=b"rev3", root_revision=b"rev3")
        self.add_revision(repo, b"rev3", inv, [b"rev1c", b"rev1a"])
        ...
        # completely wrong.
        inv = self.make_one_file_inventory(repo, b"rev4", [b"rev2"], root_revision=b"rev4")
        ...
        inv = self.make_one_file_inventory(repo, b"rev2c", [b"rev1a"], root_revision=b"rev2c")
        ...
        inv = self.make_one_file_inventory(repo, b"rev5", [b"rev2", b"rev2c"], root_revision=b"rev5")
...
class TooManyParentsScenario(BrokenRepoScenario):
    ...
    def populate_repository(self, repo):
        ...
        inv = self.make_one_file_inventory(repo, b"good-parent", (b"bad-parent",), root_revision=b"good-parent")
        self.add_revision(repo, b"good-parent", inv, (b"bad-parent",))

        inv = self.make_one_file_inventory(
            repo, b"broken-revision", (b"good-parent", b"bad-parent"), root_revision=b"broken-revision"
        )
...
class IncorrectlyOrderedParentsScenario(BrokenRepoScenario):
    ...
    def populate_repository(self, repo):
        inv = self.make_one_file_inventory(
            repo, b"parent-1", [],
            root_revision=b"parent-1")
        self.add_revision(repo, b"parent-1", inv, [])

        inv = self.make_one_file_inventory(
            repo, b"parent-2", [],
            root_revision=b"parent-2")
