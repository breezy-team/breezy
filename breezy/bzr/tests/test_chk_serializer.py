...
class TestBEncodeSerializer1(TestCase):
    ...
    def test_roundtrips_xml_invalid_chars(self):
        rev = Revision(b"revid1", properties={}, parent_ids=[], message="\t\ue000", committer='Erik B\xe5gfors', timestamp=1242385452, timezone=3600, inventory_sha1=b"4a2c7fb50e077699242cf6eb16a61779c7b680a7")
        self.assertRoundTrips(revision_bencode_serializer, rev)
