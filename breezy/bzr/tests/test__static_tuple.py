...
class TestStaticTuple(tests.TestCase):
    ...
    def test_compare_same_obj(self):
        ...
        k3 = self.module.StaticTuple("foo", 1, None, "\xb5", 1.2, 2**65, True, k1)
    ...
    def test_compare_different_types(self):
        k1 = self.module.StaticTuple("foo", "bar")
        k2 = self.module.StaticTuple("foo", 1, None, "\xb5", 1.2, 2**65, True, k1)
    ...
    def test_hash(self):
        ...
        k3 = self.module.StaticTuple("foo", 1, None, "\xb5", 1.2, 2**65, True, k)
    ...
    def test_referents(self):
        ...
        self.assertEqual(
            sorted(refs, key=key), sorted(scanner.get_referents(k), key=key)
        )
    ...
    def test_from_sequence_incorrect_args(self):
        self.assertRaises(
            TypeError, self.module.StaticTuple.from_sequence, object(), "a"
        )
