...
class TestValidTag(tests.TestCase):
    ...
    def test_ok(self):
        self.assertTrue(rio._valid_tag("foo"))

    def test_no_spaces(self):
        self.assertFalse(rio._valid_tag("foo bla"))

    def test_numeric(self):
        self.assertTrue(rio._valid_tag("3foo423"))

    def test_no_colon(self):
        self.assertFalse(rio._valid_tag("foo:bla"))

    def test_type_error(self):
        self.assertRaises(TypeError, rio._valid_tag, 423)

    def test_empty(self):
        self.assertFalse(rio._valid_tag(""))
    ...
    def test_non_ascii_char(self):
        self.assertFalse(rio._valid_tag("\xb5"))
