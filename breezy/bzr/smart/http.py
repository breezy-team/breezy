...
def _get_smart_medium(self):
    """get_smart_medium for HttpTransport, added by breezy."""
...
def install():
    """Patch HttpTransport to support the bzr smart protocol."""
    from dromedary.http.urllib import HttpTransport

    HttpTransport.get_smart_medium = _get_smart_medium
