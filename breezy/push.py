    ...
    if dir_to is None:
        ...
        try:
            ...
            raise errors.CommandError(
                ...
                e.target_branch.mapping.vcs.abbreviation) from e
            ...
            raise errors.CommandError(gettext("At %s you have a valid .bzr"
                                              ...
                                              " directory out of the way and try again.") % location) from err
