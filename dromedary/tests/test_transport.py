...
class TestTransport(tests.TestCase):
    ...
    def test_get_transport_modules(self):
        ...
        transport.register_lazy_transport(
            "foo", "dromedary.tests.test_transport", "TestTransport.SampleHandler"
        )
        transport.register_transport_proto("bar")
        transport.register_lazy_transport(
            "bar", "dromedary.tests.test_transport", "TestTransport.SampleHandler"
        )
        self.assertCountEqual(
            [
                SampleHandler.__module__,
                "dromedary.chroot",
                "dromedary.pathfilter",
            ],
    ...
    def test_transport_dependency(self):
        ...
        transport.register_transport_proto("foo")
        transport.register_lazy_transport(
            "foo", "dromedary.tests.test_transport", "BadTransportHandler"
        )
        try:
    ...
    def test_transport_fallback(self):
        ...
        transport.register_transport_proto("foo")
        transport.register_lazy_transport(
            "foo", "dromedary.tests.test_transport", "BackupTransportHandler"
        )
        transport.register_lazy_transport(
            "foo", "dromedary.tests.test_transport", "BadTransportHandler"
        )
...
class TestChrootServer(tests.TestCase):
    ...
    def test_setUp(self):
        ...
        self.assertIn(server.scheme, transport._get_protocol_handlers().keys())
    ...
    def test_stop_server(self):
        ...
        server.start_server()
        server.stop_server()
        self.assertNotIn(server.scheme, transport._get_protocol_handlers().keys())
...
class TestHooks(tests.TestCase):
    ...
    def test_transporthooks_initialisation(self):
        ...
        self.assertIn("post_connect", hookpoint, f"post_connect not in {hookpoint}")
...
class FakeVFATDecoratorTests(tests.TestCaseInTempDir):
    ...
    def get_vfat_transport(self, url):
        ...
        from ..fakevfat import FakeVFATTransportDecorator
...
class TestLocalTransports(tests.TestCase):
    ...
    def test_get_transport_from_local_url(self):
        ...
        t = transport.get_transport_from_url(here_url)
        self.assertIsInstance(t, local.LocalTransport)
...
class TestKind(tests.TestCaseInTempDir):
    def test_file_kind(self):
        ...
        try:
            ...
            self.assertEqual("chardev", file_kind(os.path.realpath("/dev/null")))
