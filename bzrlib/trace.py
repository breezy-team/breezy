...
def report_bug(exc_info, err_file):
    ...
    report_bug_to_apport(exc_info) or \
        report_bug_legacy(exc_info, err_file)
...
def report_bug_to_apport(exc_info):
    ...
    try:
        ...
        mutter("failed to find apport for automatic reporting: %s" % e)

    pr = Report()
    # TODO: include variables found walking up the stack etc, by using cgitb
    # or similar
    pr.add_proc_info()
    pr.add_user_info()
