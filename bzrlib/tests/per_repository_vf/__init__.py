...
def load_tests(standard_tests, module, loader):
    prefix = 'bzrlib.tests.per_repository_vf.'
    scenarios = []
    ...
    tests = loader.loadTestsFromModuleNames([
        ...
        prefix + 'test_repository'])
    multiply_tests(tests, scenarios, standard_tests)
    ...
    broken_scenarios_for_all_formats = multiply_scenarios(scenarios, broken_scenarios)
