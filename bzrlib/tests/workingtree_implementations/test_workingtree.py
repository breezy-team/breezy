...
from bzrlib.errors import (NotBranchError, NotVersionedError, 
                           TestPreventLocking, UnsupportedOperation,
                          )
...
class TestWorkingTreeLocking(TestCaseWithWorkingTree):
    ...
    def test_01_lock_read(self):
        ...
        self.assertEqual([('t', 'lr', True), ('b', 'lr', True),
                          ('bc', 'lr', True), ('tc', 'lr', True),
                          ('t', 'ul', True), ('tc', 'ul', True),
                          ('b', 'ul', True), ('bc', 'ul', True),
                         ], self.locks)
    ...
    def test_02_lock_write(self):
        ...
        self.assertEqual([('t', 'lw', True), ('b', 'lw', True),
                          ('bc', 'lw', True), ('tc', 'lw', True),
                          ('t', 'ul', True), ('tc', 'ul', True),
                          ('b', 'ul', True), ('bc', 'ul', True),
                         ], self.locks)
    ...
    def test_04_lock_read_fail_branch(self):
        ...
        self.assertEqual([('t', 'lr', True), ('b', 'lr', False), 
                         ], self.locks)

    def test_05_lock_write_fail_branch(self):
        # Test that the tree is not locked if it cannot lock the branch
        wt = self.get_instrumented_tree()
        ...
        self.assertEqual([('t', 'lw', True), ('b', 'lw', False), 
                         ], self.locks)
