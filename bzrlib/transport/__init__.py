...
register_lazy_transport(b'file://', 'bzrlib.transport.local', 'LocalTransport')

register_transport_proto(b'sftp://',
            help="Access using SFTP (most SSH servers provide SFTP).",
            register_netloc=True)
register_lazy_transport(b'sftp://', 'bzrlib.transport.sftp', 'SFTPTransport')
# Decorated http transport
register_transport_proto(b'http+urllib://',
#                help="Read-only access of branches exported on the web."
                         register_netloc=True)
register_lazy_transport(b'http+urllib://', 'bzrlib.transport.http._urllib',
                        'HttpTransport_urllib')
register_transport_proto(b'https+urllib://',
#                help="Read-only access of branches exported on the web using SSL."
                         register_netloc=True)
register_lazy_transport(b'https+urllib://', 'bzrlib.transport.http._urllib',
                        'HttpTransport_urllib')
register_transport_proto(b'http+pycurl://',
#                help="Read-only access of branches exported on the web."
                         register_netloc=True)
register_lazy_transport(b'http+pycurl://', 'bzrlib.transport.http._pycurl',
                        'PyCurlTransport')
register_transport_proto(b'https+pycurl://',
#                help="Read-only access of branches exported on the web using SSL."
                         register_netloc=True)
register_lazy_transport(b'https+pycurl://', 'bzrlib.transport.http._pycurl',
                        'PyCurlTransport')
...
register_lazy_transport(b'http://', 'bzrlib.transport.http._pycurl',
                        'PyCurlTransport')
register_lazy_transport(b'http://', 'bzrlib.transport.http._urllib',
                        'HttpTransport_urllib')
register_lazy_transport(b'https://', 'bzrlib.transport.http._pycurl',
                        'PyCurlTransport')
register_lazy_transport(b'https://', 'bzrlib.transport.http._urllib',
                        'HttpTransport_urllib')

register_transport_proto(b'ftp://', help="Access using passive FTP.")
register_lazy_transport(b'ftp://', 'bzrlib.transport.ftp', 'FtpTransport')
register_transport_proto(b'aftp://', help="Access using active FTP.")
register_lazy_transport(b'aftp://', 'bzrlib.transport.ftp', 'FtpTransport')
register_transport_proto(b'gio+', help="Access using any GIO supported protocols.")
register_lazy_transport(b'gio+', 'bzrlib.transport.gio_transport', 'GioTransport')
...
register_lazy_transport(b'ftp+gssapi://', 'bzrlib.transport.ftp._gssapi',
                        'GSSAPIFtpTransport')
register_lazy_transport(b'aftp+gssapi://', 'bzrlib.transport.ftp._gssapi',
                        'GSSAPIFtpTransport')
register_lazy_transport(b'ftp://', 'bzrlib.transport.ftp._gssapi',
                        'GSSAPIFtpTransport')
register_lazy_transport(b'aftp://', 'bzrlib.transport.ftp._gssapi',
                        'GSSAPIFtpTransport')
register_lazy_transport(b'ftp+nogssapi://', 'bzrlib.transport.ftp',
                        'FtpTransport')
register_lazy_transport(b'aftp+nogssapi://', 'bzrlib.transport.ftp',
                        'FtpTransport')

register_transport_proto(b'memory://')
register_lazy_transport(b'memory://', 'bzrlib.transport.memory',
                        'MemoryTransport')

register_transport_proto(b'readonly+',
#              help="This modifier converts any transport to be readonly."
            )
register_lazy_transport(b'readonly+', 'bzrlib.transport.readonly',
                        'ReadonlyTransportDecorator')

register_transport_proto(b'fakenfs+')
register_lazy_transport(b'fakenfs+', 'bzrlib.transport.fakenfs',
                        'FakeNFSTransportDecorator')

register_transport_proto(b'log+')
register_lazy_transport(b'log+', 'bzrlib.transport.log', 'TransportLogDecorator')

register_transport_proto(b'trace+')
register_lazy_transport(b'trace+', 'bzrlib.transport.trace',
                        'TransportTraceDecorator')

register_transport_proto(b'unlistable+')
register_lazy_transport(b'unlistable+', 'bzrlib.transport.unlistable',
                        'UnlistableTransportDecorator')

register_transport_proto(b'brokenrename+')
register_lazy_transport(b'brokenrename+', 'bzrlib.transport.brokenrename',
...
register_lazy_transport(b'nosmart+', 'bzrlib.transport.nosmart',
...
register_lazy_transport(b'bzr://', 'bzrlib.transport.remote',
                        'RemoteTCPTransport')
register_transport_proto(b'bzr-v2://', register_netloc=True)

register_lazy_transport(b'bzr-v2://', 'bzrlib.transport.remote',
                        'RemoteTCPTransportV2Only')
register_transport_proto(b'bzr+http://',
#                help="Fast access using the Bazaar smart server over HTTP."
                         register_netloc=True)
register_lazy_transport(b'bzr+http://', 'bzrlib.transport.remote',
                        'RemoteHTTPTransport')
...
register_transport_proto(b'bzr+ssh://',
            ...
            register_netloc=True)
register_lazy_transport(b'bzr+ssh://', 'bzrlib.transport.remote',
                        'RemoteSSHTransport')

register_transport_proto(b'ssh:')
register_lazy_transport(b'ssh:', 'bzrlib.transport.remote',
                        'HintingSSHTransport')
