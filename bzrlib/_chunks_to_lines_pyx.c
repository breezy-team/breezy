...
static PyObject *__pyx_f_6bzrlib_20_chunks_to_lines_pyx_chunks_to_lines(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":60 */
  __pyx_v_last_no_newline = 0;

  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":61 */
  ...
  for (;;) {
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":62 */
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":70 */
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":72 */
    __pyx_v_the_len = PyString_GET_SIZE(__pyx_v_chunk);

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":73 */
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":76 */
    __pyx_v_c_str = PyString_AS_STRING(__pyx_v_chunk);

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":77 */
    __pyx_v_c_last = ((__pyx_v_c_str + __pyx_v_the_len) - 1);

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":78 */
    __pyx_v_newline = ((char *)memchr(__pyx_v_c_str,'\n',__pyx_v_the_len));

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":79 */
  ...
  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":91 */
  ...
  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":92 */
  Py_INCREF(Py_None);
  Py_DECREF(__pyx_v_tail);
  __pyx_v_tail = Py_None;

  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":93 */
  ...
  for (;;) {
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":94 */
    __pyx_3 = __pyx_v_tail != Py_None;
    if (__pyx_3) {

      /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":95 */
      __pyx_2 = PyNumber_Add(__pyx_v_tail, __pyx_v_chunk); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; goto __pyx_L1;}
      Py_DECREF(__pyx_v_chunk);
      __pyx_v_chunk = __pyx_2;
      __pyx_2 = 0;

      /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":96 */
      Py_INCREF(Py_None);
      Py_DECREF(__pyx_v_tail);
      __pyx_v_tail = Py_None;
      goto __pyx_L11;
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":97 */
    __pyx_3 = (!PyString_CheckExact(__pyx_v_chunk));
    if (__pyx_3) {
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":99 */
    __pyx_v_the_len = PyString_GET_SIZE(__pyx_v_chunk);

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":100 */
    __pyx_3 = (__pyx_v_the_len == 0);
    if (__pyx_3) {
      goto __pyx_L9;
      goto __pyx_L13;
    ...
    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":104 */
    __pyx_v_c_str = PyString_AS_STRING(__pyx_v_chunk);

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":105 */
    __pyx_v_c_last = ((__pyx_v_c_str + __pyx_v_the_len) - 1);

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":106 */
    __pyx_v_newline = ((char *)memchr(__pyx_v_c_str,'\n',__pyx_v_the_len));

    /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":107 */
    __pyx_3 = (__pyx_v_newline == __pyx_v_c_last);
    if (__pyx_3) {
    ...
    /*else*/ {
      while (1) {
        ...
        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":118 */
        ...
        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":119 */
        __pyx_3 = PyList_Append(__pyx_v_lines,__pyx_v_line); if (__pyx_3 == (-1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; goto __pyx_L1;}

        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":120 */
        __pyx_v_c_str = (__pyx_v_newline + 1);

        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":121 */
        ...
        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":123 */
        __pyx_v_the_len = ((__pyx_v_c_last - __pyx_v_c_str) + 1);

        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":124 */
        __pyx_v_newline = ((char *)memchr(__pyx_v_c_str,'\n',__pyx_v_the_len));

        /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":125 */
        __pyx_3 = (__pyx_v_newline == NULL);
        if (__pyx_3) {

          /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":126 */
          ...
          /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":127 */
          goto __pyx_L16;
          goto __pyx_L18;
        }
        __pyx_L18:;
  ...
  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":128 */
  __pyx_3 = __pyx_v_tail != Py_None;
  if (__pyx_3) {
  ...
  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":130 */
...
PyMODINIT_FUNC init_chunks_to_lines_pyx(void) {
  ...
  /* "/home/vila/src/bzr/integration/2.3b5-dev/bzrlib/_chunks_to_lines_pyx.pyx":42 */
  return;
  __pyx_L1:;
