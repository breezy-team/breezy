...
check-nodocs:
	...
	set -o pipefail; BRZ_PLUGIN_PATH=$(BRZ_PLUGIN_PATH) $(PYTHON3) -Werror -Wignore::ImportWarning -Wignore::cryptography.utils.CryptographyDeprecationWarning -O \
...
check-ci: docs extensions
	...
	set -o pipefail; \
	BRZ_PLUGIN_PATH=$(BRZ_PLUGIN_PATH) $(PYTHON3) -Werror -Wignore::FutureWarning -Wignore::ImportWarning -Wignore::ResourceWarning -Wignore::cryptography.utils.CryptographyDeprecationWarning -O \
