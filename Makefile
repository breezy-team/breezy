...
check-nodocs:
	...
	set -o pipefail; BRZ_PLUGIN_PATH=$(BRZ_PLUGIN_PATH) $(PYTHON3) -Werror $(patsubst %,-Wignore::%,$(IGNORE_WARNINGS)) -O \
...
check-ci: docs extensions
	...
	set -o pipefail; \
		BRZ_PLUGIN_PATH=$(BRZ_PLUGIN_PATH) $(PYTHON3) -Werror $(patsubst %,-Wignore::%,$(IGNORE_WARNINGS)) -O \
